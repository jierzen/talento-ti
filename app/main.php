...
class Main extends Controller {
	...
	function index($f3){
		...
		// 	session_destroy();
		// }
		if(!isset($usuario) || session_status() === PHP_SESSION_NONE){
